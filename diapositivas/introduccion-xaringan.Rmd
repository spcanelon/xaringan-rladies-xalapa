...
## `r icon::fa("search")` Busquemos ejemplos de ubicación en las diapositivas ejemplares
...
## `r icon::fa("search")` Busquemos ejemplos de imagenes en las diapositivas ejemplares
...
## `r icon::fa("paper-plane")` Generar diapositivas independientes para compartir
...
## `r icon::fa("link")` Generar un enlace para las diapositivas que se puede compartir
