...
```{r}
knitr::include_url("https://remarkjs.com")
```
]
...
**xaringan** es un paquete que le presenta `remark.js` a R Markdown
...
**Primer paso** Install the `nhsrtheme` package from GitHub
