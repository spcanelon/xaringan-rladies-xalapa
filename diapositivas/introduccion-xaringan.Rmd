...
<br>[`r icon::fa("images")` diapositivas/introduccion-xaringan ](https://spcanelon.github.io/xaringan-rladies-xalapa/diapositivas/introduccion-xaringan.html)
...
.pull-right[
**La clase `.pull-right[]` (_jalar-derecha_) jala contenido al<br>47% derecho**
...
## Generar diapositivas independientes para compartir
